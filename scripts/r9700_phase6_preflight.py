#!/usr/bin/env python3
"""Fail-closed production preflight for HyperLoom R9700 Phase 6."""
...
def main() -> int:
    ...
    state = svc.stdout.strip()
    checks["stock_service_state"] = state
    checks["stock_service_inactive"] = state != "active"
