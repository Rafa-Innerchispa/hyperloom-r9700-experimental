    ...
    stages: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "requirements": {
                ...
                "reason": (
                    "vLLM v0.29.0 build metadata pins torch 2.13.0 and its validated ROCm "
                    "Dockerfile pins ROCm/triton f0b55c0; build both identities explicitly."
                ),
